...
#### <button onclick="Android.sendButtonCallback(PFN, Title)"> &#x2197; </button> "Send page ..."

You can send current page as file. Page file will be wraped by some meta information which required to correct import. Tested with Telegram and K-9 Mail
...
#### <button onclick="Android.prefButtonCallback()"> &#x1f527; </button> "Edit application settings"
...
(or change Tag to Tags and place string to page header)
